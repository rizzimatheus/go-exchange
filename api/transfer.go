...
// GET http://localhost:8080/transfers/1
...
// GET http://localhost:8080/transfers/?from_account_id=8&to_account_id=9&page_id=1&page_size=5
...
// validAccount compares whether the account and currency given are compatible
