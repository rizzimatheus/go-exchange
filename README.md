...
## 1. Database [Postgres]
- [x] v1.1 - Design DB schema and generate SQL code with [dbdiagram](https://dbdiagram.io/)
- [x] v1.2 - Setup Docker Compose + Postgres + TablePlus to create DB schema
- [x] v1.3 - Write and Run database migration with [Migrate](https://github.com/golang-migrate/migrate)
- [x] v1.4 - Generate CRUD code from SQL with [SQLC](https://sqlc.dev/)
...
- [x] v1.6 - Implement database transaction
- [x] v1.7 - Setup Github Actions for Golang + Postgres to run automated tests

## 2. Building RESTful HTTP JSON API [Gin]
- [x] v2.1 - Implement RESTful HTTP API using [Gin](https://github.com/gin-gonic/gin) and custom params validator
